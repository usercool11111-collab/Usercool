    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          className="group relative bg-emerald-500 hover:bg-emerald-400 text-slate-950 p-3.5 sm:p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-200 flex items-center justify-center border-2 border-emerald-300/40"
        ...
        <a
          ...
          className="group relative bg-white/10 hover:bg-white/20 border-2 border-emerald-500/40 text-emerald-400 p-3.5 sm:p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-200 flex items-center justify-center backdrop-blur-md"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#05070A]/95 border-t border-white/10 backdrop-blur-md px-4 py-3 flex items-center justify-between gap-3 shadow-2xl">
        <div className="space-y-0.5">
          <div className="text-xs font-black text-white flex items-center gap-1">
            ...
            <span className="text-[10px] bg-emerald-500/20 text-emerald-400 px-1.5 rounded-full border border-emerald-500/20">4.9 ★</span>
          </div>
        ...
        <button
          ...
          className="bg-emerald-600 text-white font-bold px-4 py-2.5 rounded-full text-xs shadow-[0_0_15px_rgba(16,185,129,0.4)] flex items-center gap-1 shrink-0"
        >
